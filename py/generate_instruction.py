...
def encode_prompt(prompt_instructions):
    ...
    logging.info("Generateing prompt: %s", prompt)
    return prompt
...
def generate_instruction_following_data(
    ...
    while len(machine_instruction_data) < num_instructions_to_generate:
        ...
        decoding_args = utils.OpenAIDecodingArguments(
            ...
            n=1,
            max_tokens=2802,  # hard-code to maximize the length. the requests will be automatically adjusted
            top_p=top_p,
            stop=["\n20", "20.", "20."],
        )
        ...
        logging.info("Obtained the following instruction set: %s", instruction_data)
